...
/**
 * Model for the Family Name prefix (Surname) table
 * PHP version 7.3.9
 *
 * @category Model
 * @package  MMS
...
/**
 * Attributes and methods for the Model for the Family Name prefix (Surname) table
 *
 * @category Model
 * @package  MMS
 * @author   Barry S. Rayfield <barry.rayfield@gmail.com>
...
class Surname extends Model
{
    ...
    /**
     * Lookup and return Users record based on the id
     *
     * @return user record
     */
