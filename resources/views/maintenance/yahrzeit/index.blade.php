...
@section('content')
    ...
    @if(Session::has('yahrzeitStatus'))
        <div class="row">
            <div class="col-sm-12 alert alert-info text-center">
                {{session('yahrzeitStatus')}}
            </div>
        </div>
    @endif
        ...
        @foreach($mmsGlobals as $mmsGlobal)
            <div class="row pt-1 pb-1 detail-borders">
                ...
                <div class="col-sm-2 m-sm-auto text-center">
                    <a href="{{route('yahrzeit.edit', $mmsGlobal->id)}}" class="btn btn-primary">
                        <span class="fa fw fa-edit"></span> Edit
                    </a>
                </div>
                <div class="col-sm-2 m-sm-auto text-center">
                    {{-- <a href="{{route('yahrzeit.show', $mmsGlobal->id)}}" class="btn btn-primary">
