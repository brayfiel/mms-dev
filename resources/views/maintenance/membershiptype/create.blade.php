...
<form method="POST" action="{{route("membershiptype.store")}}">
    @csrf
    <div class="row mt-5">
    ...
    <div class="row">
        <div class="offset-sm-1 col-sm-4 form-group">
            <input type="submit" name="submit" class="btn btn-primary btn-block" value="Create Membership Type">
        </div>
