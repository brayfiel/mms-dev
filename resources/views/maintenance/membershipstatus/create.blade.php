...
<div class="row">
    ...
    <div class="col-sm-10 text-center">
        <h1>Create Membership Statuses</h1>
    </div>
    <div class="col-sm-1 text-center">
        <img src="{{asset("images/jewish_star.jpg")}}" alt="Jewish Star" height="42">
    </div>
...
<form method="POST" action="{{route("membershipstatus.store")}}">
    @csrf
    <div class="row mt-5">
    ...
    <div class="row">
        <div class="offset-sm-1 col-sm-4 form-group">
            <input type="submit" name="submit" class="btn btn-primary btn-block" value="Create Membership Status">
        </div>
