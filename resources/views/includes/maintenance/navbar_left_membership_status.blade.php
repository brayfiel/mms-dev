<nav class="sidebar-nav">
    <ul class="metismenu" id="menu1">
        <li class="text-primary font-weight-bold">
            <div>
                <span class="fa fa-fw fa-square"></span> Membership Status
            </div>
        </li>
        <li class="mm-active">
            <a href="{{url('maintenance/membershipstatus/create')}}">
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    <a href="{{url("maintenance/membershipstatus/setsearch")}}">
        ...
        <li>
            ...
            <ul class="metismenu">
                <li>
                    <a href="/maintenance/membershipstatus/sortorder/1">
                        <span class="fa fa-fw fa-sort"></span> Id
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershipstatus/sortorder/3">
                        <span class="fa fa-fw fa-sort"></span> Description
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershipstatus/sortorder/4">
        ...
        <li>
            ...
            <ul class="metismenu">
                <li>
                    <a href="/maintenance/membershipstatus/printall/id" target="_blank">
                        <span class="fa fa-fw fa-sort"></span> Id
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershipstatus/printall/description" target="_blank">
                        <span class="fa fa-fw fa-sort"></span> Description
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershipstatus/printall/lastupdated" target="_blank">
                        <span class="fa fa-fw fa-sort"></span> Last Updated
                    </a>
                </li>
            </ul>
...
<div class="modal fade" tabindex="-1" id="findId" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form method="GET" action="{{url("maintenance/membershipstatus/setsearch")}}">
                <div class="modal-header">
                    <h4 class="modal-title text-primary">Find A Membership Type Id</h4>
                    ...
                    <div class="row form-group">
                        <div class="offset-sm-1 col-sm-10">
                            <input
                                ...
                                class="form-control"
                                name="id"
                                placeholder="Enter A Membership Type Id"
                                min="1"
                            >
                        </div>
                    </div>
...
<div class="modal fade" tabindex="-1" id="findDescription" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form method="GET" action="{{url("maintenance/membershipstatus/setsearch")}}">
                <div class="modal-header">
                    <h4 class="modal-title text-primary">Find A Membership Type Description</h4>
                    <button type="button" class="close text-primary" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body text-primary">
                    <div class="row form-group">
                        <div class="offset-sm-1 col-sm-10">
                            <input
                                ...
                                class="form-control"
                                name="description"
                                placeholder="Enter A Membership Type Description"
                            >
                        </div>
                    </div>
                </div>
