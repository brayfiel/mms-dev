<nav class="sidebar-nav">
    <ul class="metismenu" id="menu1">
        <li class="text-primary font-weight-bold">
            <div>
                <span class="fa fa-fw fa-square"></span> Membership Type
            </div>
        </li>
        <li class="mm-active">
            <a href="{{url('maintenance/membershiptype/create')}}">
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    <a href="{{url("maintenance/membershiptype/setsearch")}}">
        ...
        <li>
            ...
            <ul class="metismenu">
                <li>
                    <a href="/maintenance/membershiptype/sortorder/1">
                        <span class="fa fa-fw fa-sort"></span> Id
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershiptype/sortorder/3">
                        <span class="fa fa-fw fa-sort"></span> Description
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershiptype/sortorder/4">
        ...
        <li>
            ...
            <ul class="metismenu">
                <li>
                    <a href="/maintenance/membershiptype/printall/id" target="_blank">
                        <span class="fa fa-fw fa-sort"></span> Id
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershiptype/printall/description" target="_blank">
                        <span class="fa fa-fw fa-sort"></span> Description
                    </a>
                </li>
                <li>
                    <a href="/maintenance/membershiptype/printall/lastupdated" target="_blank">
                        <span class="fa fa-fw fa-sort"></span> Last Updated
                    </a>
                </li>
            </ul>
...
<div class="modal fade" tabindex="-1" id="findId" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form method="GET" action="{{url("maintenance/membershiptype/setsearch")}}">
